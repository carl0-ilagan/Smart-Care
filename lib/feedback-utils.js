...
export const respondToFeedback = async (feedbackId, response, respondedBy = null, responderProfile = {}) => {
  try {
    const feedbackRef = doc(db, "feedback", feedbackId)
    ...
    await updateDoc(feedbackRef, {
      ...
      ...(responderProfile?.name ? { respondedByName: responderProfile.name } : {}),
      ...(responderProfile?.photoURL ? { respondedByPhotoURL: responderProfile.photoURL } : {}),
    })
